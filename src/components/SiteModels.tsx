...
export default function SiteModels() {
  ...
  // Lista de modelos para carregar dinamicamente
  const models = [
    {
      id: 1,
      thumb: "/web-5.jpg",
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {models.map((model) => (
            <div
              ...
              className="cursor-pointer bg-gray-900/60 hover:bg-gray-800/80 p-6 rounded-2xl 
              shadow-lg border border-gray-800 hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-2"
            >
              <img
                src={model.thumb}
...
{activeGallery !== null && (
  ...
  >
    ...
    >
      ...
      {/* ---------- GRID RESPONSIVA PARA AS OUTRAS DUAS ---------- */}
