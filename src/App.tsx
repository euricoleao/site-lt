...
//      {/* 🏠 Seção Início */}
// <section id="inicio" className="min-h-screen flex flex-col lg:flex-row items-center justify-between px-8 lg:px-24 py-20 bg-gradient-to-b from-[#030014] to-[#020024] text-white">
...
//     <a href="#modelos-sites" className="block">
...
//               Conheça alguns dos projetos que desenvolvemos para nossos clientes, unindo design moderno,
//               performance e presença digital de alto impacto.
//             </p>
