...
export default function Home() {
  return (
    <>
      ...
      <section
        id="inicio"
        className="relative min-h-screen flex flex-col lg:flex-row items-center justify-between  px-6 lg:px-20  py-20 text-white overflow-hidden"
      >
        {/* 🎥 Vídeo de fundo */}
        <video
          src="/bg-atraba.mp4"
    ...
    /> */}
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8  mx-auto w-full px-6 sm:px-8 md:px-12 lg:px-20 xl:px-32">
          {/* Criação de Sites */}
          <Link to="/modelos-sites" className="block">
            <img
              src="/site.png"
              alt="sites"
              className="mx-auto mb-4 w-30 h-20 rounded-b-2xl"
            />
            <div className="relative overflow-hidden p-6 rounded-2xl shadow-md w-full h-60 group">
              {/* Vídeo de fundo */}
              <video
                src="/videocases.mp4"
                autoPlay
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-3xl font-extrabold  text-blue-300 mb-[-6px] pt-4  mt-22">
                  Criar Sites
                </h3>
  ...
  "
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-10">
          ...
          <div className="text-white md:w-1/2 ">
            ...
            <p className="text-gray-300 leading-relaxed mb-6 w-[300px]">
              Conheça algumas soluções dos projetos que desenvolvemos para
              nossos clientes, unindo design moderno, performance e presença
      ...
      "
        ...
        "
            />
            <p className="absolute top-5 left-1/2 -translate-x-1/2 text-white text-xl font-semibold drop-shadow-lg max-w-[90%] text-center">
